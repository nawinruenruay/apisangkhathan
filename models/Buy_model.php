...
class Buy_model extends Model
{
    ...
    function Buyproduct() 
    {
        ...
        INSERT into tb_orders_detail(order_id, cid, order_date, status, pay_date, pay_time, pay_total, pay_slip)
        values('$order_id', '$cid', '$order_date', '$status', '', '00:00', '', '')
        ");
        ...
        foreach ($row_x as $row) {
            ...
            DELETE from tb_cart where cid='$cid' and pid='$pid' and qty='$qty' and price='$price'
            ");
